...
class DocumentsHome extends StatefulWidget {
  @override
  _DocumentsHomeState createState() => _DocumentsHomeState();
}
                          ...
                          return GestureDetector(
                            onTap: () async {
                              ...
                              await _asyncSimpleDialog(context,
                                  docu['docUrl'], docu['fileName'],docu['title']);
                            },
                            child: DocumentCard(
                              type: docu['type'],
                              title: docu['title'],
  ...
  void _shareInApps(String filename, String link) async {
    try {
      WcFlutterShare.share(
          ...
          subject: "Download",
          text:
              "Download document via this link: FileName: $filename $link \n Visit agriglance.com for more such materials",
          mimeType: 'text/plain');
    } catch (e) {
      print(e);
    }
